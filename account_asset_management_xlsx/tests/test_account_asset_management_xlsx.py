        ...
        self.asset_1 = self.env["account.asset"].create(
            {
                ...
                "date_start": str((fields.Date.today() - relativedelta(years=1)).year)
                + "-01-01",
            }
        )
        ...
        self.asset_2 = self.env["account.asset"].create(
            {
                ...
                "profile_id": self.asset_profile.id,
                "date_start": str((fields.Date.today() - relativedelta(years=2)).year)
                + "-01-01",
            }
        )
